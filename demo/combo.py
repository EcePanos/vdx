            ...
            for row in csv_reader:
                ...
                for i in range(len(row)):
                    ...
                    if success[i] >= sum(success)/len(success):
                        ...
                        w[i] = 0
            print(w)
            print("Times reverted to previous result: " + str(skipped))
            print("Times reverted to simple average: " + str(reverted))
